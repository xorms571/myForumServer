...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; font-src 'self' https://myforumserver-production.up.railway.app; img-src 'self' https://myforumserver-production.up.railway.app; script-src 'self' 'unsafe-eval'; style-src 'self';"
  );
  next();
});
